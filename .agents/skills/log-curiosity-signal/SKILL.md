...
(`.Codex/skills/log-curiosity-signal/CURIOSITY-SIGNAL-LOG.md`), under a `## YYYY-MM-DD` heading
...
- **[tag]** Tight paraphrase or short quote of what was said. Context: what prompted
  it, in one clause. (Optional) Codex's read on why, explicitly marked as a guess if
