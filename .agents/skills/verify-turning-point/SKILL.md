...
1. The target scene: `app/story/<slug>/page.tsx`. Extract the prose only (ignore JSX/CSS);
   ...
   note.
2. `.Codex/skills/turning-point-scene/SKILL.md` — the structural contract the writer was
...
3. `.Codex/skills/verify-turning-point/calibration/bipedalism.md`, specifically its
...
4. `.Codex/skills/verify-turning-point/calibration/_cross-story-themes.md` — the user's own
